{application,rabbit_common,
             [{description,"Modules shared by rabbitmq-server and rabbitmq-erlang-client"},
              ...
              {modules,[app_utils,code_version,credit_flow,delegate,
                        delegate_sup,ec_semver,ec_semver_parser,gen_server2,
                        mirrored_supervisor,mochijson2,mochinum,mochiweb_util,
                        ...
                        rabbit_cert_info,rabbit_channel,
                        ...
                        rabbit_writer,rand_compat,ssl_compat,supervisor2,
                        time_compat]},
              {registered,[]},
